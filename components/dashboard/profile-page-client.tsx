      ...
      <div className="max-w-[1200px] mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* personal info */}
            <div className="bg-white dark:bg-[#0E1F3F] dark:bg-[#0E1F3F] rounded-xl border border-slate-100 dark:border-white/[0.08] dark:border-white/[0.08] p-6">
              <h3 className="text-[16px] font-medium text-slate-900 dark:text-[#E2E8F0] dark:text-[#E2E8F0] mb-4">Personal Information</h3>
              <div className="space-y-4">
                <div>
                  <label className="text-[13px] text-slate-500 dark:text-[#6B7A99] dark:text-[#6B7A99] mb-1 block">Full Name</label>
                  {isEditing ? (
                    <input
                      type="text"
                      value={fullName}
                ...
                <div>
                  <label className="text-[13px] text-slate-500 dark:text-[#6B7A99] dark:text-[#6B7A99] mb-1 block">Email Address</label>
                  {isEditing ? (
                    <input
                      type="email"
                      value={email}
            ...
            <div className="bg-white dark:bg-[#0E1F3F] dark:bg-[#0E1F3F] rounded-xl border border-slate-100 dark:border-white/[0.08] dark:border-white/[0.08] p-6">
              ...
              <p className="text-[13px] text-slate-400 dark:text-[#6B7A99] dark:text-[#6B7A99]">
            ...
            {/* QR card info */}
            <div className="bg-white dark:bg-[#0E1F3F] dark:bg-[#0E1F3F] rounded-xl border border-slate-100 dark:border-white/[0.08] dark:border-white/[0.08] p-6">
              <h3 className="text-[16px] font-medium text-slate-900 dark:text-[#E2E8F0] dark:text-[#E2E8F0] mb-4">QR Access Card</h3>
              <div className="flex items-center gap-4">
                <div className="h-14 w-14 rounded-xl bg-slate-100 dark:bg-white/[0.06] dark:bg-white/[0.06] flex items-center justify-center">
