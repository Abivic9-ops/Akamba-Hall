        ...
        <div className="w-full">
          <div className="flex flex-col gap-2 mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[12px] text-slate-600">Overdue</span>
              <span className="text-[12px] font-medium text-slate-800 ml-auto">{overdueCount}</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[#EAB308]" />
              <span className="text-[12px] text-slate-600">Due This Week</span>
              <span className="text-[12px] font-medium text-slate-800 ml-auto">{dueThisWeek}</span>
            </div>
          </div>
