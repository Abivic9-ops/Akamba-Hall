...
export function StaffDigitalCard({ label, memberId, userName, status, qrCodeUrl, cardRef }: StaffDigitalCardProps) {
  ...
  const handleDownload = useCallback(async () => {
    ...
    try {
      ...
      link.download = `akamba-hall-staff-qr-${cardRef ?? memberId}.png`
