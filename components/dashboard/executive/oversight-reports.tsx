  ...
  return (
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-[15px] font-semibold text-slate-900">Oversight Reports</h3>
          <p className="text-[12px] text-slate-400 mt-0.5">Institutional metrics</p>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[12px] text-slate-500">Borrowing Trend</p>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-[12px] text-slate-500">Overdue Rate</p>
            <span className="inline-flex items-center gap-1 text-[13px] font-semibold text-emerald-600">
        ...
        <div className="space-y-2.5 pt-2 border-t border-slate-100">
          <div>
            <p className="text-[12px] text-slate-500 mb-1">Booking Utilization</p>
            <BarIndicator value={bookingUtilization} color="bg-[#0D9488]" />
          </div>
          <div>
            <p className="text-[12px] text-slate-500 mb-1">Equipment Usage</p>
            <BarIndicator value={equipmentUsage} color="bg-[#8B5CF6]" />
          </div>
          <div>
            <p className="text-[12px] text-slate-500 mb-1">Space Utilization</p>
