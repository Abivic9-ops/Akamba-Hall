...
export function ExecutivePrivilegesCard() {
  return (
    <div className="mx-3 mb-3 p-4 rounded-xl bg-white dark:bg-[#0E1F3F] dark:bg-[#0E1F3F]/5 border border-amber-500/20">
      ...
      <div className="space-y-1">
        {[
          ...
          <div key={item.label} className="flex items-center gap-2 py-1">
            ...
            <span className="text-xs text-slate-400 dark:text-[#6B7A99] dark:text-[#6B7A99]">{item.label}</span>
          </div>
        ))}
      </div>
    </div>
