  ...
  return (
    <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-[15px] font-semibold text-slate-900">Executive Summary</h3>
          <p className="text-[12px] text-slate-400 mt-0.5">Key institutional numbers</p>
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-slate-50 rounded-lg p-3">
          ...
          <p className="text-[20px] font-bold text-slate-900">{totalMembers.toLocaleString()}</p>
        ...
        <div className="bg-slate-50 rounded-lg p-3">
          ...
          <p className="text-[20px] font-bold text-slate-900">{activeStaff}</p>
        ...
        <div className="bg-slate-50 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[11px] text-slate-500">Audit Highlights</p>
          </div>
          <p className="text-[20px] font-bold text-slate-900">{auditHighlights}</p>
