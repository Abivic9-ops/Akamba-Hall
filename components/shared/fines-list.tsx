...
export function FinesList({ loans }: { loans: FineItem[] }) {
    ...
    <div className="min-h-screen bg-[#F8F9FB] dark:bg-[#071224]">
      <div className="max-w-[1440px] mx-auto p-6 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-[#0B1B3D] dark:text-[#E2E8F0] tracking-tight">Fines</h1>
            <p className="text-[12px] text-slate-500 dark:text-[#6B7A99]">View outstanding fines and charges</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#0E1F3F] rounded-2xl p-5 border border-slate-100 dark:border-white/[0.08] shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-[13px] text-slate-400 dark:text-[#6B7A99]">Overdue Items</p>
              <p className="text-[28px] font-bold text-slate-900 dark:text-[#E2E8F0]">{overdueLoans.length}</p>
            </div>
        ...
        <SectionCard title="All Loans" icon={DollarSign}>
                ...
                <div key={l.id} className="flex items-center gap-3 p-3 hover:bg-slate-50 dark:hover:bg-white/[0.04] rounded-xl transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[12px] text-slate-400 dark:text-[#6B7A99]">
                      {l.author} · Due {format_date(l.dueDate)}
                    </p>
                  </div>
