        ...
        <SectionCard title="Feature Toggles" icon={ToggleLeft}>
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <div className="h-16 w-16 rounded-2xl bg-slate-100 dark:bg-white/[0.06] flex items-center justify-center mb-4">
              <ToggleLeft className="h-7 w-7 text-slate-300 dark:text-[#6B7A99]" />
            </div>
            <h3 className="text-[15px] font-medium text-slate-700 dark:text-[#E2E8F0] mb-1">Feature Flags</h3>
            <p className="text-[13px] text-slate-400 dark:text-[#6B7A99] max-w-xs">
              Enable or disable experimental features and roll out changes gradually.
            </p>
          </div>
        </SectionCard>
      </div>
