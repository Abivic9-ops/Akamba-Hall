  ...
  return (
    <div className="p-6 md:p-8 max-w-[1400px] mx-auto pb-20">
      <FadeIn>
        ...
        <h1 className="text-[32px] font-extrabold text-[#0B1B3D] tracking-tight">Member Management</h1>
        <p className="text-[#5B6376] text-[16px] mt-2">Search, register, and manage library members.</p>
      </FadeIn>
      ...
      <FadeIn delay={0.1}>
        <ScaleOnHover>
          <div className="mt-8 bg-white dark:bg-[#0E1F3F] dark:bg-[#0E1F3F] border border-[#E4E7EE] dark:border-white/10 dark:border-white/10 rounded-[20px] p-10 text-center flex flex-col items-center justify-center min-h-[400px] hover:shadow-lg hover:border-gold/30 transition-all duration-300">
            ...
            <h2 className="text-[20px] font-bold text-[#101828]">Members Module</h2>
            <p className="text-[#5B6376] text-[15px] max-w-md mx-auto mt-3 leading-relaxed">
              This view is a placeholder and will be built out in the upcoming phases. The members module will include registration, profile management, role assignment, and activity tracking.
            </p>
