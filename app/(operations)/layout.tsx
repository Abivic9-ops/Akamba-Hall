        ...
        <aside className="w-[260px] bg-[#0B1B3D] border-r border-slate-200 hidden lg:flex flex-col h-[calc(100vh-64px)] sticky top-16 overflow-y-auto overflow-x-hidden custom-scrollbar text-white">
          <div className="p-4 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <Link href="/desk" className="flex items-center justify-between px-3 py-2.5 text-[13px] font-medium text-[#F5A623] bg-white/10 rounded-lg transition relative">
              ...
              <Link href="/desk" className="flex items-center justify-between px-3 py-2 text-[13px] font-medium text-white/80 hover:text-white hover:bg-white/5 rounded-lg transition">
              ...
              <Link href="/desk" className="flex items-center gap-3 px-3 py-2 text-[13px] font-medium text-white/80 hover:text-white hover:bg-white/5 rounded-lg transition">
          ...
          <div className="mt-auto p-4 mb-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col gap-3">
              ...
              <Link href="/desk" className="mt-2 w-full py-2 bg-transparent border border-white/20 text-white rounded font-bold text-[11px] text-center hover:bg-white/10 transition">
                View Full Report
              </Link>
            </div>
          </div>
