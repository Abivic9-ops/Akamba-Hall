    ...
    <div className="w-full bg-white">
      ...
      <section id="visit" className="py-24 px-4">
        <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <h2 className="text-[30px] md:text-[36px] font-bold text-[#101828] mt-6 mb-3">Visit Us</h2>
            ...
            <div className="bg-[#F5F6FA] border border-[#E4E7EE] rounded-[20px] p-6 flex flex-col gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[14px] font-bold text-[#101828]">Address</span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[14px] font-bold text-[#101828]">Phone</span>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-[14px] font-bold text-[#101828]">Email</span>
          ...
          <div id="hours">
            ...
            <h2 className="text-[30px] md:text-[36px] font-bold text-[#101828] mt-6 mb-3">Library Hours</h2>
            <p className="text-[16px] text-[#5B6376] leading-relaxed mb-8">
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-[#0B1A3B]">
                    <th className="px-6 py-4 text-[13px] font-bold text-gold uppercase tracking-wider">Day</th>
                    <th className="px-6 py-4 text-[13px] font-bold text-gold uppercase tracking-wider">Hours</th>
                    <th className="px-6 py-4 text-[13px] font-bold text-gold uppercase tracking-wider">Note</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[#E4E7EE] hover:bg-white/60 transition-colors">
                    <td className="px-6 py-4 text-[14px] font-semibold text-[#101828]">Monday – Friday</td>
                  ...
                  <tr className="border-b border-[#E4E7EE] hover:bg-white/60 transition-colors">
                    <td className="px-6 py-4 text-[14px] font-semibold text-[#101828]">Saturday</td>
                  ...
                  <tr className="hover:bg-white/60 transition-colors">
                    <td className="px-6 py-4 text-[14px] font-semibold text-[#101828]">Sunday &amp; Public Holidays</td>
                    <td className="px-6 py-4 text-[14px] font-semibold text-red-500">Closed</td>
      ...
      <section id="help-desk" className="py-24 px-4 bg-[#F5F6FA]">
        <div className="container mx-auto max-w-5xl">
          ...
          <h2 className="text-[30px] md:text-[36px] font-bold text-[#101828] mt-6 mb-3">Ask a Librarian</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white border border-[#E4E7EE] rounded-[20px] p-8">
              <h3 className="text-[18px] font-bold text-[#101828] mb-6">Submit Your Request</h3>
              <div className="flex flex-col gap-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[13px] font-semibold text-[#101828]">Your Name</label>
                    <input
                      type="text"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-[13px] font-semibold text-[#101828]">Email</label>
                    <input
                      type="email"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-semibold text-[#101828]">Subject</label>
                  <input
                    type="text"
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-[13px] font-semibold text-[#101828]">Message</label>
                  <textarea
                    rows={5}
                ...
                <button className="h-11 bg-gold hover:bg-gold-hover text-navy font-bold rounded-xl text-[15px] flex items-center justify-center gap-2 transition-all" aria-label="Send request to librarian">
            ...
            <div className="flex flex-col gap-6">
              <h3 className="text-[18px] font-bold text-[#101828]">What We Can Help With</h3>
              <StaggerChildren>
              {[
                ...
                <div className="flex gap-4 bg-white border border-[#E4E7EE] rounded-[16px] p-5 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    <h4 className="text-[15px] font-bold text-[#101828]">{item.title}</h4>
      ...
      <section id="feedback" className="py-24 px-4">
        <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-[30px] md:text-[36px] font-bold text-[#101828] mt-6 mb-3">Feedback</h2>
          ...
          <div className="bg-[#F5F6FA] border border-[#E4E7EE] rounded-[20px] p-7">
            ...
            <h3 className="text-[18px] font-bold text-[#101828] mb-4">Submit Feedback</h3>
            <div className="flex flex-col gap-4">
              ...
              />
              <button className="h-10 bg-gold hover:bg-gold-hover text-navy font-bold rounded-xl text-[14px] transition-all" aria-label="Submit feedback">
                Submit Feedback
              </button>
            </div>
          </div>
      ...
      <section id="lost-card" className="py-24 px-4 bg-[#F5F6FA]">
        <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <h2 className="text-[30px] md:text-[36px] font-bold text-[#101828] mt-6 mb-3">Lost Card / Login Help</h2>
            <p className="text-[16px] text-[#5B6376] leading-relaxed mb-6">
            ...
            <div className="bg-white border border-[#E4E7EE] rounded-[20px] p-7">
              <h3 className="text-[18px] font-bold text-[#101828] mb-6">Steps to Recover Access</h3>
              <div className="flex flex-col gap-5">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    <div className="shrink-0 h-8 w-8 rounded-full bg-gold text-navy text-[12px] font-bold flex items-center justify-center">
                      {s.step}
                    </div>
                    <div>
          ...
          <div>
            ...
            <div className="bg-white border border-[#E4E7EE] rounded-[20px] p-7">
              ...
              <h3 className="text-[18px] font-bold text-[#101828] mb-2">Report a Problem</h3>
              ...
              <div className="flex flex-col gap-4">
                ...
                <button className="h-11 bg-gold hover:bg-gold-hover text-navy font-bold rounded-xl text-[15px] transition-all" aria-label="Submit lost card or login report">
                  Submit Report
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 bg-[#0B1A3B] rounded-[20px] p-7">
              <h3 className="text-[17px] font-bold text-white mb-3">Need Immediate Help?</h3>
